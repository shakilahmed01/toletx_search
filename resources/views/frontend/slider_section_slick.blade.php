 ...
 <body>
     ...
     <!-- slider section -->
      <section>
        <div class="slider-container container-fluid responsive">
                <div class="card mx-5 px-5" style="width: 10rem;">
                ...
                <div class="card mx-5 px-5" style="width: 10rem;">
                    <img class="card-img-top" src="{{asset('Frontend/assets/img/header/s5.jpg')}}" alt="Card image cap"> 
                </div>
                <div class="card mx-5 px-5" style="width: 10rem;">
                    <img class="card-img-top" src="{{asset('Frontend/assets/img/header/s1.jpg')}}" alt="Card image cap"> 
                </div>
