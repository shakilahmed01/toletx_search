                 ...
                 <div class="col-md-7 mx-4">
                     ...
                     <ul class="nav nav-tabs" id="myTab" role="tablist">
                         ...
                         <li class="nav-item" role="presentation">
                             <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile"
                                 type="button" role="tab" aria-controls="profile" aria-selected="false">Other
                                 Information</button>
                         </li>
                         <li class="nav-item" role="presentation">
                             <button class="nav-link" id="contact-tab" data-bs-toggle="tab" data-bs-target="#contact"
                                 type="button" role="tab" aria-controls="contact" aria-selected="false">Payment
                                 Information</button>
                         </li>
                         <li class="nav-item" role="presentation">
                          <button class="nav-link" id="customer_need-tab" data-bs-toggle="tab" data-bs-target="#customer_need"
                              type="button" role="tab" aria-controls="customer_need" aria-selected="false">Customer Advertise
                              </button>
                         </li>
                     ...
                     <div class="tab-content" id="myTabContent">
                         ...
                         <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                             <div class="p-3 py-5">
                                 <div class="d-flex justify-content-between align-items-center mb-3">
                                     <h4 class="text-right">Other Information</h4>
                                 </div>
                                 <div class="row mt-2">
                                     <div class="col-md-12">
                                         <label class="labels">
                                     ...
                                     <div class="col-md-12">
                                         <label class="labels">
                                             <i class="icofont-phone"></i>
                                             <span class="info-type">Phone Number :</span>
                                             <span class="info">0165000000001</span>
                                         </label>
                                     </div>
                                     <div class="col-md-12">
                                         <label class="labels">
                         ...
                         <div class="row mt-2   service-group-row">
                                               <div class="col-md-2 col-small mx-2 pb-3 pt-3 pb-3 main-service text-center " onclick="location.href='{{route('wanted_list_room')}}'">
                                           ...
                                           <div class="row mt-2 service-group-row">
                                               ...
                                               <div class="col-md-2 col-small mx-2 pb-3 pt-3 main-service text-center" onclick="location.href='{{route('wanted_list_billboard')}}'">
