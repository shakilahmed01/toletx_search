                ...
                <div class="col-md-7 mx-4">
                    <div class="row  ">
                      <div class="col-md-2 col-small mx-2 main-service text-center" onclick="location.href='{{route('community_hall')}}'">
                                  <span class="icon-community service_item"></span>
                                      <br>
                 ...
                 <div class="items">
                   ...
                   @foreach($array as $arrays)
                     <div class="card ml-3 mr-4 slick-slider-card" style=   "width: 12rem">
                       <img
                         src="{{ asset('uploads/shops') }}/{{ $arrays->photo }}"
                         class="card-img-top"
                         alt="..."
                       />
                       <div class="card-body main-slider-body main-slider-body">
                         ...
                         <button type="button" class="btn btn-custom-color2 check-detail mt-2">
                           <a href="{{ url('community/custom/search/details') }}/{{ $arrays->id }}" class="btn  ">Check Details</a>
                         </button>
