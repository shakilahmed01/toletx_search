                ...
                <div class="col-md-7 mx-4">
                    ...
                    <div class="row ml-4 mr-4 ">
                        <div class="container container-fluid">
                            <form class = "form-horizontal top-form" action="{{route('exibution_search')}}" role = "form">
                          ...
                          <div class="mt-3">
                            ...
                            <div class="form-check form-check-inline ml-3">
                                <input class="form-check-input" type="checkbox" id="attached_veranda" value="wifi">
                     ...
                     <div class="card ml-3 mr-4 slick-slider-card" style=   "width: 12rem">
                       ...
                       <div class="card-body main-slider-body">
                         ...
                         <button type="button" class="btn btn-custom-color2 check-detail mt-2">
                           <a href="{{ url('/exibution/details/') }}/{{ $flat->id }}"class="btn  ">Check Details</a>
                         </button>
