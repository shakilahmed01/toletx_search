                 ...
                 <div class="col-md-6 col-sm-12">
                   ...
                   <div class="custom-control custom-checkbox mb-5">
                     ...
                     <label class="custom-control-label" for="customCheck1">Parking</label>
 									...
 									<div class="custom-control custom-checkbox mb-5">
                     <input type="checkbox" name="protection" class="custom-control-input" id="customCheck2">
                   ...
                   <div class="custom-control custom-checkbox mb-5">
                     <input type="checkbox" name="shed" class="custom-control-input" id="customCheck8">
